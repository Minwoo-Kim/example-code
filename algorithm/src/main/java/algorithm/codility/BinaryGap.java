 ...
 * For example, given N = 1041 the function should return 5, because N has binary representation 10000010001 and so its longest binary gap is of length 5. Given N = 32 the function
...
public class BinaryGap {
	public static void main(String[] args) {
		System.out.println(new BinaryGap().doExecute(529));
	}

	public int doExecute(int N) {
		int result = 0;
		...
		while (!binaryString.isEmpty()) {
			...
			int binaryGap = binaryString.indexOf('1');
			if (binaryGap < 0)
				break;
